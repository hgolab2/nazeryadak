...
<nav class="mb-3 pt-md-3" aria-label="Breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> {{l('مدیریت مشتریان')}}</li>
    </ol>
</nav>
    ...
    <div class=" card-body border-0  pb-1 me-lg-1">
        <div class="row">
            <div class="col-md-6 col-lg-3 col-sm-12 mt-3">
                <label for="id" id="label_id" class="form-label fw-bold">کد</label>
                <input type="text" name="id" id="id" value="" class="form-control">
            </div>
            <div class="col-md-6 col-lg-3 col-sm-12 mt-3">
                <label for="name" id="label_name" class="form-label fw-bold">نام</label>
                <input type="text" name="name" id="name" value="" class="form-control">
            </div>
            <div class="col-md-6 col-lg-3 col-sm-12 mt-3">
                <label for="phone" id="label_phone" class="form-label fw-bold">تلفن</label>
...
<script>
    ...
    function destroy(id) {
        swal({
            text: " {{l('آیا از حذف مشتری مورد نظر اطمینان دارید؟')}}",
            type: 'warning',
