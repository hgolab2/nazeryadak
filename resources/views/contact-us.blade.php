        ...
        <div class="row">
                    ...
                    <div class="row px-3 pb-3">
                        <div class="col-sm-6 mb-4">
                            <div class="text-center p-3" style="background: var(--primary-lighter); border-radius: var(--radius);">
                                ...
                                <h2 class="font-14 fw-bold">تلفن تماس</h2>
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="text-center p-3" style="background: var(--primary-lighter); border-radius: var(--radius);">
                                <x-brand-icon name="whatsapp" class="mb-2" style="font-size: 2rem; color: #25d366;" />
                                <h2 class="font-14 fw-bold">واتساپ</h2>
                                <p class="font-13 mb-1">۰۹۱۲۷۴۷۱۶۳۱</p>
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="text-center p-3" style="background: var(--primary-lighter); border-radius: var(--radius);">
                                ...
                                <h2 class="font-14 fw-bold">ایمیل</h2>
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="text-center p-3" style="background: var(--primary-lighter); border-radius: var(--radius);">
                                ...
                                <h2 class="font-14 fw-bold">آدرس</h2>
            ...
            <div class="col-lg-4">
                <div class="cart-content p-4">
                    <h2 class="font-14" style="font-weight:700; margin-bottom: 15px;"><i class="fas fa-question-circle me-2" style="color:var(--accent);"></i> سوالی دارید؟</h2>
                ...
                <div class="cart-content p-4 mt-3">
                    <h2 class="font-14" style="font-weight:700; margin-bottom: 15px;"><i class="fas fa-clock me-2" style="color:var(--primary);"></i> ساعات کاری</h2>
