        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="cart-content about-us">
                    ...
                    <div class="px-2">
                        ...
                        <h2 style="font-size: 1rem; color: var(--primary); font-weight:700;">چرا ناظر یدک؟</h2>
                        <p>
                        ...
                        <h2 style="font-size: 1rem; color: var(--primary); font-weight:700;">مأموریت ما</h2>
                        <p>
                        ...
                        <h2 style="font-size: 1rem; color: var(--primary); font-weight:700;">تعهدات ما</h2>
            ...
            <div class="col-lg-4">
                <div class="cart-content text-center p-4">
                    ...
                    <h2 style="font-size: 1rem; font-weight:700;">تخصص ما: لوازم یدکی خودرو</h2>
                ...
                <div class="cart-content p-4 mt-3">
                    <h2 style="font-size: 1rem; font-weight:700; margin-bottom: 15px;"><i class="fas fa-phone-alt me-2" style="color:var(--primary);"></i> ارتباط سریع</h2>
