        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="cart-content about-us p-4">
                    ...
                    <h2 style="font-size:.95rem; color:var(--primary); font-weight:700;">۱. مقدمه</h2>
                    ...
                    <h2 style="font-size:.95rem; color:var(--primary); font-weight:700;">۲. ثبت‌نام و حساب کاربری</h2>
                    ...
                    <h2 style="font-size:.95rem; color:var(--primary); font-weight:700;">۳. قیمت‌گذاری و پرداخت</h2>
                    ...
                    <h2 style="font-size:.95rem; color:var(--primary); font-weight:700;">۴. ارسال سفارش</h2>
                    ...
                    <h2 style="font-size:.95rem; color:var(--primary); font-weight:700;">۵. بازگشت و تعویض</h2>
                    ...
                    <h2 style="font-size:.95rem; color:var(--primary); font-weight:700;">۶. مالکیت معنوی</h2>
                    <p>کلیه محتوای سایت شامل متون، تصاویر، لوگو و طراحی متعلق به ناظر یدک بوده و هرگونه کپی‌برداری بدون اجازه کتبی ممنوع است.</p>

                    <h2 style="font-size:.95rem; color:var(--primary); font-weight:700;">۷. محدودیت مسئولیت</h2>
