...
<style>
    /* نسخه‌ی چاپی: فقط خود پیش‌فاکتور روی کاغذ بیاید */
    @media print {
        header, footer, .mobile-appbar, .mobile-actionbar, .checkout-steps, .btn, nav {
            display: none !important;
        }
        .cart-content { box-shadow: none !important; border: 1px solid #ddd; }
    }
</style>
@endsection
